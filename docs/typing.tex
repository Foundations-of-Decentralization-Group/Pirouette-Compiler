...
\subsection{Auxiliary Functions}
    ...
    \begin{itemize}
        \item \textbf{extract\_local\_ctx} \texttt{: global\_ctx -> string -> local\_ctx}\\
              ...
              That is, \highlighttexttt{extract\_local\_ctx [\ldots; (A, foo, int); \ldots; (A, bar, string) \ldots] A = [(foo, int), (bar, string)]}.
        ...
        \item \textbf{get\_choreo\_subst} \texttt{: local\_subst -> Local.loc\_id -> choreo\_subst}\\
              ...
              That is, \highlighttexttt{get\_choreo\_ctx [(T1, int -> int)] A = [(T1, (Choreo.TLoc (A), int -> int))]}.
              Use \href{https://ocaml.org/manual/5.2/api/List.html#VALfold_right}{\highlighttexttt[orange]{List.fold\_right}}
        ...
        \item \textbf{get\_choreo\_ctx} \texttt{: local\_ctx -> Local.loc\_id -> choreo\_ctx}\\
              ...
              That is, \highlighttexttt{get\_choreo\_ctx [(foo, int)] A = [(foo, (Choreo.TLoc ((A), int)))]}.
              Use \href{https://ocaml.org/manual/5.2/api/List.html#VALfold_right}{\highlighttexttt[orange]{List.fold\_right}}
              to preserve the order of the context since the program update the context by adding the new type binding to the front of the context.
        ...
        \item \textbf{occurs\_in} \texttt{: typvar -> Local.typ -> bool}\\
              \highlighttexttt{occurs\_in t typ} return true if the type variable \highlighttexttt{t} occurs in the type \highlighttexttt{typ}.
              That is, \highlighttexttt{occurs\_in T1 (int -> T1)} return \highlighttexttt[orange]{true}.
        ...
        \item \textbf{unify\_local \& unify\_choreo} \\
              \texttt{: Local.typ -> Local.typ -> local\_subst \&\\
                  Choreo.typ -> Choreo.typ -> choreo\_subst}\\
              \highlighttexttt{unify\_local typ1 typ2 subst} return the substitution that unifies the type \highlighttexttt{typ1} with the type \highlighttexttt{typ2}
              and return the result substitution \highlighttexttt{subst}.
              ...
              The functionality of \highlighttexttt{unify\_choreo} is the same as \highlighttexttt{unify\_local}, 
