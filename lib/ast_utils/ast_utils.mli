(** {b ast_utils} AST utility functions
    ...
    - Serialization and pretty-printing– functions prefixed with [jsonify_*] and
      [pprint_*] convert ASTs to JSON or formatted source text.
    ...
    help understand how Pirouette code becomes an AST, whre you can see the
