  ...
  | 8 ->
      let rec broadcast_opt freq =
        ...
        | "R" ->
            ...
            let rec _unit_32 =
              let val_31 = x in
              Mpi.send (Marshal.to_string val_31 []) (loc_to_rank "A") 0
                Mpi.comm_world in
            ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
  | 9 ->
      let rec broadcast_opt freq =
        ...
        | "R" ->
            ...
            let rec _unit_36 =
              let val_35 = x in
              Mpi.send (Marshal.to_string val_35 []) (loc_to_rank "A") 0
                Mpi.comm_world in
            ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
  ...
  | 11 ->
      let rec broadcast_opt freq =
        ...
        | "L" ->
            ...
            let rec _unit_44 =
              let val_43 = x in
              Mpi.send (Marshal.to_string val_43 []) (loc_to_rank "A") 0
                Mpi.comm_world in
            broadcast_opt ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
  | 12 ->
      let rec broadcast_opt freq =
        ...
        | "L" ->
            ...
            let rec _unit_46 =
              let val_45 = x in
              Mpi.send (Marshal.to_string val_45 []) (loc_to_rank "A") 0
                Mpi.comm_world in
            broadcast_opt ()
        | "R" ->
            let rec x = 9 in
  ...
  | 14 ->
      let rec broadcast_opt freq =
        ...
        | "L" ->
            ...
            let rec _unit_56 =
              let val_55 = x in
              Mpi.send (Marshal.to_string val_55 []) (loc_to_rank "A") 0
                Mpi.comm_world in
            broadcast_opt ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
