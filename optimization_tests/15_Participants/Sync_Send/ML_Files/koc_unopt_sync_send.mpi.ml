  ...
  | 0 ->
    ...
    let rec broadcast_unopt freq =
      ...
      then (
        ...
        in
        let rec result_H =
          Marshal.from_string (Mpi.receive (loc_to_rank "H") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_I =
          Marshal.from_string (Mpi.receive (loc_to_rank "I") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_J =
          Marshal.from_string (Mpi.receive (loc_to_rank "J") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_K =
          Marshal.from_string (Mpi.receive (loc_to_rank "K") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_L =
          Marshal.from_string (Mpi.receive (loc_to_rank "L") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_M =
          Marshal.from_string (Mpi.receive (loc_to_rank "M") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_N =
          Marshal.from_string (Mpi.receive (loc_to_rank "N") Mpi.any_tag Mpi.comm_world) 0
        in
        let rec result_O =
  ...
  | 1 ->
    let rec broadcast_unopt freq =
      ...
      | "R" ->
        ...
        let rec _unit_4 =
          let val_3 = x in
          Mpi.send (Marshal.to_string val_3 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
  ...
  | 2 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_6 =
          let val_5 = x in
          Mpi.send (Marshal.to_string val_5 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | "R" ->
        let rec x = 9 in
  ...
  | 3 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_12 =
          let val_11 = x in
          Mpi.send (Marshal.to_string val_11 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
  ...
  | 6 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_22 =
          let val_21 = x in
          Mpi.send (Marshal.to_string val_21 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | "R" ->
        let rec x = 9 in
        let rec _unit_24 =
          let val_23 = x in
          Mpi.send (Marshal.to_string val_23 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
  ...
  | 8 ->
    let rec broadcast_unopt freq =
      ...
      | "R" ->
        ...
        let rec _unit_32 =
          let val_31 = x in
          Mpi.send (Marshal.to_string val_31 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
  ...
  | 9 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_34 =
          let val_33 = x in
          Mpi.send (Marshal.to_string val_33 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | "R" ->
        let rec x = 9 in
        let rec _unit_36 =
          let val_35 = x in
          Mpi.send (Marshal.to_string val_35 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
  ...
  | 11 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_42 =
          let val_41 = x in
          Mpi.send (Marshal.to_string val_41 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | "R" ->
        let rec x = 9 in
        let rec _unit_44 =
          let val_43 = x in
          Mpi.send (Marshal.to_string val_43 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
  ...
  | 12 ->
    let rec broadcast_unopt freq =
      ...
      | "R" ->
        ...
        let rec _unit_46 =
          let val_45 = x in
          Mpi.send (Marshal.to_string val_45 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
      | "L" ->
        let rec x = 10 in
  ...
  | 13 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_52 =
          let val_51 = x in
          Mpi.send (Marshal.to_string val_51 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
  ...
  | 14 ->
    let rec broadcast_unopt freq =
      ...
      | "L" ->
        ...
        let rec _unit_54 =
          let val_53 = x in
          Mpi.send (Marshal.to_string val_53 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        broadcast_unopt ()
      | "R" ->
        let rec x = 9 in
        let rec _unit_56 =
          let val_55 = x in
          Mpi.send (Marshal.to_string val_55 []) (loc_to_rank "A") 0 Mpi.comm_world
        in
        ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
