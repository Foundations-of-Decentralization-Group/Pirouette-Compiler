  ...
  | 0 ->
    ...
    let rec loop iter =
      ...
      then (
        ...
        let result_arr = Mpi.gather "result" (loc_to_rank "P1") Mpi.comm_world in
        let val_arr = Array.get result_arr 1 in
        let val_arr = Marshal.from_string val_arr 0 in
        print_endline ("Value is this: " ^ string_of_int val_arr);
        loop (iter - 1))
      else (
  ...
  | 1 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec _unit_32 =
          let val_31 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_31 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
    let rec _unit_33 = loop () in
    ()
  | 2 ->
    let rec gettimeofday arg = Unix.gettimeofday arg in
    let rec print_float arg = Stdlib.print_float arg in
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec _unit_49 =
          ...
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_48 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
  ...
  | 3 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_66 =
          let val_65 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_65 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
    let rec _unit_67 = loop () in
    ()
  | 4 ->
    let rec gettimeofday arg = Unix.gettimeofday arg in
    let rec print_float arg = Stdlib.print_float arg in
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec _unit_83 =
          ...
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_82 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
  ...
  | 5 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_100 =
          let val_99 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_99 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
  ...
  | 6 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_117 =
          let val_116 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_116 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
    let rec _unit_118 = loop () in
    ()
  | 7 ->
    let rec gettimeofday arg = Unix.gettimeofday arg in
    let rec print_float arg = Stdlib.print_float arg in
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_134 =
          let val_133 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_133 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec _unit_151 =
          ...
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_150 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" ->
  ...
  | 9 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_168 =
          let val_167 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_167 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" ->
  ...
  | 10 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_185 =
          let val_184 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_184 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
    let rec _unit_186 = loop () in
    ()
  | 11 ->
    let rec gettimeofday arg = Unix.gettimeofday arg in
    let rec print_float arg = Stdlib.print_float arg in
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_202 =
          let val_201 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_201 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" ->
  ...
  | 12 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        ...
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_219 =
          let val_218 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_218 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" ->
  ...
  | 13 ->
    ...
    let rec loop iter =
      ...
      | "L" ->
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_236 =
          let val_235 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_235 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
    let rec _unit_237 = loop () in
    ()
  | 14 ->
    let rec gettimeofday arg = Unix.gettimeofday arg in
    let rec print_float arg = Stdlib.print_float arg in
    ...
    let rec loop iter =
      ...
      | "L" ->
        let rec result = test_collatz 931386509544713451 in
        let rec _unit_253 =
          let val_252 = result in
          Mpi.gather (Marshal.to_string result []) (loc_to_rank "P1") Mpi.comm_world
          (* Mpi.send (Marshal.to_string val_252 []) (loc_to_rank "P1") 0 Mpi.comm_world *)
        in
        loop ()
      | "R" -> ()
      | _ -> failwith "Runtime Error: Unmatched label"
    in
    let rec _unit_254 = loop () in
    ()
