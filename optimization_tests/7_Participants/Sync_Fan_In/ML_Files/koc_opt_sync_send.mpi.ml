          ...
          (Mpi.send "R" (loc_to_rank "B") 0 Mpi.comm_world;
           ...
           (let rec result_B =
            ...
            let rec result_G =
              Marshal.from_string
                (Mpi.receive (loc_to_rank "C") Mpi.any_tag Mpi.comm_world) 0 in
            print_endline "Terminate - Optimized")) in
            ...
            (Mpi.send "L" (loc_to_rank "D") 0 Mpi.comm_world;
             ...
             (let rec x = 10 in
              ...
              let rec _unit_4 =
                ...
                Mpi.send (Marshal.to_string val_3 []) (loc_to_rank "A") 0
                  Mpi.comm_world in
              let rec result_E =
                Marshal.from_string
            ...
            (Mpi.send "L" (loc_to_rank "F") 0 Mpi.comm_world;
             ...
             (let rec x = 10 in
              ...
              let rec _unit_16 =
                ...
                Mpi.send (Marshal.to_string val_15 []) (loc_to_rank "A") 0
                  Mpi.comm_world in
              let rec result_G =
                Marshal.from_string
        ...
        | "R" ->
            (Mpi.send "R" (loc_to_rank "F") 0 Mpi.comm_world;
             ...
             (let rec x = 9 in
              let rec _unit_24 =
                let val_23 = x in
                Mpi.send (Marshal.to_string val_23 []) (loc_to_rank "A") 0
                  Mpi.comm_world in
              let rec result_F =
                Marshal.from_string
                  (Mpi.receive (loc_to_rank "F") Mpi.any_tag Mpi.comm_world)
  ...
  | 3 ->
      let rec broadcast_opt freq =
        ...
        | "R" ->
            ...
            let rec _unit_26 =
              let val_25 = x in
              Mpi.send (Marshal.to_string val_25 []) (loc_to_rank "B") 0
                Mpi.comm_world in
            ()
        | "L" ->
            let rec x = 10 in
            let rec _unit_28 =
              let val_27 = x in
              Mpi.send (Marshal.to_string val_27 []) (loc_to_rank "B") 0
                Mpi.comm_world in
            broadcast_opt ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
  | 4 ->
      let rec broadcast_opt freq =
        ...
        | "L" ->
            ...
            let rec _unit_30 =
              let val_29 = x in
              Mpi.send (Marshal.to_string val_29 []) (loc_to_rank "B") 0
                Mpi.comm_world in
            broadcast_opt ()
        | "R" ->
            let rec x = 9 in
            let rec _unit_32 =
              let val_31 = x in
              Mpi.send (Marshal.to_string val_31 []) (loc_to_rank "B") 0
                Mpi.comm_world in
            ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
  | 5 ->
      let rec broadcast_opt freq =
        ...
        | "L" ->
            ...
            let rec _unit_34 =
              let val_33 = x in
              Mpi.send (Marshal.to_string val_33 []) (loc_to_rank "C") 0
                Mpi.comm_world in
            broadcast_opt ()
        | "R" ->
            let rec x = 9 in
            let rec _unit_36 =
              let val_35 = x in
              Mpi.send (Marshal.to_string val_35 []) (loc_to_rank "C") 0
                Mpi.comm_world in
            ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
  | 6 ->
      let rec broadcast_opt freq =
        ...
        | "L" ->
            ...
            let rec _unit_38 =
              let val_37 = x in
              Mpi.send (Marshal.to_string val_37 []) (loc_to_rank "C") 0
                Mpi.comm_world in
            broadcast_opt ()
        | "R" ->
            let rec x = 9 in
            let rec _unit_40 =
              let val_39 = x in
              Mpi.send (Marshal.to_string val_39 []) (loc_to_rank "C") 0
                Mpi.comm_world in
            ()
        | _ -> failwith "Runtime Error: Unmatched label" in
      broadcast_opt ()
