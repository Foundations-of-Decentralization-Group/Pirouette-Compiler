...
(* let test_simple _ =
  ...
  let suite =
    ...
    >::: [
      ...
      ("String Tests" 
        >::: [
          ("test_change_string 1 2 \"hello\"" >:: fun _ -> test_change_string_LOC 1 2 "hello");
          ("test_change_string 2 3 \"hellonjdvsbvjsbgjkbs\"" >:: fun _ -> test_change_string_LOC 2 3 "hellonjdvsbvjsbgjkbs");
          ("test_change_string 10 20 \"hi\"" >:: fun _ -> test_change_string_LOC 10 20 "hi");
          ("test_change_string 1000 2000 \"hello\"" >:: fun _ -> test_change_string_LOC 1000 2000 "hello");
          ("test_change_string (-1) (-2) \"hello\"" >:: fun _ -> test_change_string_LOC (-1) (-2) "hello");
        ]);
      ("Bool Tests" 
        >::: [
          ...
          ("test_change_bool 10 20 false" >:: fun _ -> test_change_bool_LOC 10 20 false);
          ("test_change_bool 1000 2000 true" >:: fun _ -> test_change_bool_LOC 1000 2000 true);
          ("test_change_bool (-1) (-2) false" >:: fun _ -> test_change_bool_LOC (-1) (-2) false);
        ]);
      ("Operators Tests" 
        >::: [
      ...
      ("Expression Tests" 
        >::: [
          ...
          ("test_expression_let 1 2 3 4" >:: fun _ -> test_expression_let_LOC 1 2 3 4);
