...
let test_expression_let_LOC (old_meta:int) (new_meta: int) (input_int: int) (input_int2: int) =
...
;; 
let test_type_sum_LOC (old_meta: int) (new_meta: int) (input_int: int) (input_int2: int) =
  let old_sum = Local.M.TSum ((Local.M.TUnit old_meta),(Local.M.TString input_int),input_int2) in
  let new_sum = LocalAst.set_info_typ new_meta old_sum in
  assert_equal new_meta (LocalAst.get_info_typ (new_sum))
;; 
let test_type_prod_LOC (old_meta: int) (new_meta: int) (input_int: int) (input_int2: int) =
...
(*-----------------------------------------------------------*)
  let loc_suite =
    ...
    >::: [
      ("Int Tests" 
        >::: [
          ("test_change_int_LOC 1 2" >:: fun _ -> test_change_int_LOC 1 2);
          ("test_change_int_LOC 2 3" >:: fun _ -> test_change_int_LOC 2 3);
          ("test_change_int_LOC 10 20" >:: fun _ -> test_change_int_LOC 10 20);
          ("test_change_int_LOC (-1) (-2)" >:: fun _ -> test_change_int_LOC (-1) (-2));
          ("test_change_int 1000 2000_LOC" >:: fun _ -> test_change_int_LOC 1000 2000);
        ]);
      ("String Tests" 
        >::: [
          ("test_change_string_LOC 1 2 \"hello\"" >:: fun _ -> test_change_string_LOC 1 2 "hello");
          ("test_change_string_LOC 2 3 \"hellonjdvsbvjsbgjkbs\"" >:: fun _ -> test_change_string_LOC 2 3 "hellonjdvsbvjsbgjkbs");
          ("test_change_string_LOC 10 20 \"hi\"" >:: fun _ -> test_change_string_LOC 10 20 "hi");
          ("test_change_string_LOC 1000 2000 \"hello\"" >:: fun _ -> test_change_string_LOC 1000 2000 "hello");
          ("test_change_string_LOC (-1) (-2) \"hello\"" >:: fun _ -> test_change_string_LOC (-1) (-2) "hello");
        ]);
      ("Bool Tests" 
        >::: [
          ("test_change_bool_LOC 1 2 false" >:: fun _ -> test_change_bool_LOC 1 2 false);
          ("test_change_bool_LOC 2 3 true" >:: fun _ -> test_change_bool_LOC 2 3 true);
          ("test_change_bool_LOC 10 20 false" >:: fun _ -> test_change_bool_LOC 10 20 false);
          ("test_change_bool_LOC 1000 2000 true" >:: fun _ -> test_change_bool_LOC 1000 2000 true);
          ("test_change_bool_LOC (-1) (-2) false" >:: fun _ -> test_change_bool_LOC (-1) (-2) false);
        ]);
      ("Operators Tests" 
        >::: [
          ("test_plus_LOC 1 2" >:: fun _ -> test_plus_LOC 1 2);
          ("test_minus_LOC 1 2" >:: fun _ -> test_minus_LOC 1 2);
          ("test_or_LOC 1 2" >:: fun _ -> test_or_LOC 1 2);
          ("test_and_LOC 1 2" >:: fun _ -> test_and_LOC 1 2);
          ("test_not_LOC 1 2" >:: fun _ -> test_not_LOC 1 2);
          ("test_neg_LOC 1 2" >:: fun _ -> test_neg_LOC 1 2);
          ("test_type_int_LOC 1 2" >:: fun _ -> test_type_int_LOC 1 2);
          ("test_type_string_LOC 1 2" >:: fun _ -> test_type_string_LOC 1 2);
          ("test_type_bool_LOC 1 2" >:: fun _ -> test_type_bool_LOC 1 2);
          ("test_times_LOC 1 2" >:: fun _ -> test_times_LOC 1 2);
          ("test_div_LOC 1 2" >:: fun _ -> test_div_LOC 1 2);
          ("test_lt_LOC 1 2" >:: fun _ -> test_lt_LOC 1 2);
          ("test_gt_LOC 1 2" >:: fun _ -> test_gt_LOC 1 2);
          ("test_leq_LOC 1 2" >:: fun _ -> test_leq_LOC 1 2);
          ("test_geq_LOC 1 2" >:: fun _ -> test_geq_LOC 1 2);
          ("test_neq_LOC 1 2" >:: fun _ -> test_neq_LOC 1 2);
          ("test_eq_LOC 1 2" >:: fun _ -> test_eq_LOC 1 2);
        ]);
      ("Type Tests" 
        >::: [
          ("test_type_int_LOC 1 2" >:: fun _ -> test_type_int_LOC 1 2);
          ("test_type_string_LOC 1 2" >:: fun _ -> test_type_string_LOC 1 2);
          ("test_type_bool_LOC 1 2" >:: fun _ -> test_type_bool_LOC 1 2);
          ("test_type_prod_LOC 1 2 3 4" >:: fun _ -> test_type_prod_LOC 1 2 3 4);
          ("test_type_sum_LOC 1 2 3 4" >:: fun _ -> test_type_sum_LOC 1 2 3 4);
          ("test_type_var_LOC 1 2 3" >:: fun _ -> test_type_var_LOC 1 2 3);
          ("test_type_unit_LOC 1 2" >:: fun _ -> test_type_unit_LOC 1 2);
          ("test_type_id_LOC 1 2" >:: fun _ -> test_type_id_LOC 1 2);
          ("test_var_id_LOC 1 2" >:: fun _ -> test_var_id_LOC 1 2);
          ("test_loc_id_LOC 1 2" >:: fun _ -> test_loc_id_LOC 1 2);
        ]);
      ("Pattern Tests" 
        >::: [
          ("test_pattern_default_LOC 1 2" >:: fun _ -> test_pattern_default_LOC 1 2);
          ("test_pattern_value_LOC 1 2" >:: fun _ -> test_pattern_value_LOC 1 2);
          ("test_pattern_variable_LOC 1 2" >:: fun _ -> test_pattern_variable_LOC 1 2);
          ("test_pattern_left_LOC 1 2" >:: fun _ -> test_pattern_left_LOC 1 2);
          ("test_pattern_right_LOC 1 2" >:: fun _ -> test_pattern_right_LOC 1 2);
          ("test_pattern_pair_LOC 1 2" >:: fun _ -> test_pattern_pair_LOC 1 2);
        ]);
      ("Expression Tests" 
        >::: [
          ("test_expression_unit_LOC 2" >:: fun _ -> test_expression_unit_LOC 2);
          ("test_expression_val_LOC 1 2" >:: fun _ -> test_expression_val_LOC 1 2);
          ("test_expression_unop_LOC 1 2" >:: fun _ -> test_expression_unop_LOC 1 2);
          ("test_expression_var_LOC 1 2" >:: fun _ -> test_expression_var_LOC 1 2);
          ("test_expression_binop_LOC 1 2" >:: fun _ -> test_expression_binop_LOC 1 2);
          ("test_expression_let_LOC 1 2 3 4" >:: fun _ -> test_expression_let_LOC 1 2 3 4);
          ("test_expression_fst_LOC 1 2" >:: fun _ -> test_expression_fst_LOC 1 2);
          ("test_expression_snd_LOC 1 2" >:: fun _ -> test_expression_snd_LOC 1 2);
          ("test_expression_left_LOC 1 2" >:: fun _ -> test_expression_left_LOC 1 2);
          ("test_expression_right_LOC 1 2" >:: fun _ -> test_expression_right_LOC 1 2);
          ("test_expression_match_LOC 1 2" >:: fun _ -> test_expression_match_LOC 1 2);
          ("test_expression_pair_LOC 1 2" >:: fun _ -> test_expression_pair_LOC 1 2);
        ])
    ]
